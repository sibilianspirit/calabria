...
- **Street food**: poprawka geograficzna potwierdzona – Soverato i Corigliano-Rossano leżą nad Morzem Jońskim, nie Tyrreńskim (cuoppo rozdzielone wg wybrzeży). Sagra del pescespada w Bagnara Calabra: błędna „druga niedziela lipca” zastąpiona ostrożniejszym „tradycyjnie pierwsza niedziela sierpnia, data zmienna” (edycja 2026 wypadła 24–26 lipca). Dodane: dosłowne znaczenie „a ruota di carro”, opis feluki (passerella, maszt antenna), status IGP Tartufo di Pizzo od 2024 (pierwszy lód w Europie) — **⚠ błąd, poprawione 2026-09-23: Tartufo di Pizzo NIE jest w eAmbrosia, zob. „Stan 2026-09-23 (12)”**, sycylijskie pochodzenie Don Pippo jako źródło techniki formowania lodów jak arancini
...
## Stan 2026-09-23 (9) – fact-check redaktorski: Lungomare Falcomatà (Reggio)
- PL+EN: bulwar „w Reggio”, „sformułowanie przypisywane D’Annunziowi”, **fatamorgana** (łącznie, małą literą – norma PWN; na tej stronie; 6 innych plików PL ma jeszcze „Fata Morgana”/„fata morgana” – do decyzji), nagłówek „Architektura liberty” → „Zabytkowe pałace” (Villa Zerbi = neogotyk wenecki), tessery, Wiktor Emanuel III, „władze Reggio” zamiast Comune, passeggiata + lody/granita z bergamotką, Wiosna Reggio (*Primavera di Reggio*); description przepisany (był ucięty „…”)
- Potwierdzone: Valentino asesor ds. robót publicznych od 1911, potem burmistrz (lata kadencji w źródłach rozbieżne 1914/1916 – bez daty); Corso Vittorio Emanuele III = via Marina alta, poziom wyżej, z kamienicami liberty (it.wikipedia); Cippo Marmoreo: projekt **Camillo Autore**, brązowa Atena **Antonio Bonfiglio**, odsłonięty V 1932 (classicult.it)
- **Nie przyjęte**: Paolo Orsi jako odkrywca term i murów – niepotwierdzone (turismo.reggiocal.it: termy odsłonięte przy odbudowie po 1908, bez nazwiska); „perła weneckiego neogotyku”; „współczesny pomnik” Ateny (to 1932); włoska nazwa muzeum w PL (zostaje polska, także w „W pobliżu” zamiast starego „Museo Nazionale della Magna Grecia”)

## Stan 2026-09-23 (10) – fact-check redaktorski: Plaże Tropei
- PL+EN: banały usunięte (Karaiby, „dramatyczne klify”, „mniej znany skarb”), klify z piaskowca i tufu, Morze Tyrreńskie w intro, „był wyspą”, kamieniołomem, lokalsów → miejscowych, belvedere → punkt widokowy, spiaggia libera objaśniona, Cipolla Rossa di Tropea Calabria IGP (pełna nazwa z „Calabria” – redaktor ją pominął); styl urzędowy o okresie kąpielowym i Scoglio del Palombaro przepisany; description przepisany (był ucięty „…”)
...
## Stan 2026-09-23 (12) – fact-check redaktorski: Tartufo di Pizzo
- PL+EN (7351252): czas przeszły w anegdocie o Don Pippo, arystokratyczne wesele (nie „patrzyjuszowskie”), truflę/trufli, lokal z ponad stuletnią tradycją (nie *secolare*), w Gelaterii Enrico w dzielnicy Marinella (Via Prangi), Wybrzeże Bogów w intro, Murat i Piedigrotta (w tufie) opisane przy linkach; description przepisany (był ucięty „…”)
- **IGP rozstrzygnięte w eAmbrosia** (filtr `protectedName` przez `eambrosia-public-api/api/gi-applications/filter`, ciało zapytania jak w UI rejestru; curl dostaje 301, działa z przeglądarki Playwright): „Tartufo di Pizzo” nie figuruje ani jako zarejestrowane, ani jako wniosek (kontrola: Cipolla Rossa di Tropea Calabria 2008, Peperoncino di Calabria 11.06.2026 – są). Zdanie „w 2024 r. pierwszy lód z IGP w Europie” na Street food PL+EN (sesja 22.09) było błędne – poprawione; „wniosek odrzucony” na stronie Pizzo zastąpiony „nie trafiła do rejestru” (odrzucenia nie da się potwierdzić)
- **Błędy redaktora**: „wiśnia nie jest dopuszczona” – disciplinare z GU 12.12.2007 wprost dopuszcza *ciliegia sciroppata* i posypkę kakao + cukier pół na pół (zostaje); „procedura utknęła na etapie krajowym” – nazwa została przekazana Komisji; „odczekać w temperaturze pokojowej” – nie ma tego w specyfikacji (zdanie o „lekko przymarzniętym” zastąpione neutralnym „zjada się od razu w lodziarni”); ceny 6–8 € niezweryfikowane – nie dodane

## Stan 2026-09-23 (13) – fact-check redaktorski: Zamek Normański w Bovie
- PL+EN (75cc10c): tytuł „Zamek Normandzki” → „Zamek Normański”, sklepienie kolebkowe (nie beczkowe), machikuły (wł. *caditoie*), wieża Torre Parcopia cylindryczna z szerszą podstawą (nie „unicyrkularna”), greka kalabryjska / *grecanico*, Wielka Grecja, „dostępne bezpłatnie”; usunięte zdanie z karty katalogowej (współrzędne WGS84, własność podmiotu publicznego) i asekuracyjne zdanie o przyczynach ruiny; description przepisany (był ucięty „…”); pigułka „Zamek Normański” także na Sentiero dell'Inglese; w „W pobliżu” „Dziedzictwo grekanickie” (tak jak tytuł strony docelowej, nie „grekańskie”)
- **Legenda uzupełniona szerzej, niż proponował redaktor**: odcisk stopy tradycja przypisuje legendarnej królowej-założycielce Bovy (it.wikipedia: ormiańska; reggiotoday: grecka, Oichista), skarb strzeżony przez węża; wariant z Matyldą z Canossy istnieje (calabriagreca.it), ale mówi, że dziewczyna o pasującej stopie pochodzi z jej rodu – nie jest to główna wersja, jak podał redaktor
...
## Stan 2026-09-23 (15) – fact-check redaktorski: Kościół Piedigrotta (Pizzo)
- PL+EN: banały usunięte („najbardziej niezwykłe w całych Włoszech”, „kamienna opowieść/katecheza”), medagliony → medalony, grupy dewocyjne → figury lokalnego kultu, polskie imiona świętych (Franciszek z Paoli – patron Kalabrii, Antoni z Padwy, Matka Boża Pompejańska…), tufo/arenaria/calcarenite objaśnione; ostrzeżenie o stromym podejściu z plaży do centrum; zdanie o fotografowaniu i chłodzie przeniesione do informacji praktycznych; description przepisany (był ucięty „…”)
- **Wyciekła notatka robocza** „To dane do ponownej weryfikacji przed publikacją” w akapicie o biletach – usunięta; bilety „stan na czerwiec 2026”, zimą do 17:00; bilet łączony z Castello Murat (zamkiem aragońskim) – ten sam obiekt co „Castello Aragonese”
- **Błąd redaktora**: „koniec XVII w. + dzwon 1632 to nielogiczne” – it.wikipedia podaje katastrofę „verso la fine del 1600”, dzwon jest po prostu starszy od katastrofy; zostaje „pod koniec XVII wieku” z dopiskiem
- Dodane wg it.wikipedia (Chiesetta di Piedigrotta, dodana do źródeł): marynarze z Torre del Greco, obraz Maria SS. di Piedigrotta (kult neapolitański – stąd nazwa; potwierdza sugestię redaktora [DO WERYFIKACJI]) w kajucie kapitana; dokument z 1725 – fundatorzy Giovanni Benedetto i syn Antonio (1675); Angelo Barone zmarł 1915, zostawiał bloki tufu na posągi; Giorgio = syn Alfonsa, 1969 (nie „koniec lat 60.”), dwa medalony
- Nie przyjęte: „Santa Rita koronowana przez Anioła Śmierci” skrócone do „św. Rita” (za redaktorem – szczegół niezweryfikowany)

## Stan 2026-09-23 (16) – fact-check redaktorski: Castello Murat (Pizzo)
- PL+EN: tytuł „Castello Murat w Pizzo”, nagłówek „od twierdzy do miejsca egzekucji” (nowe id ASCII, bez „sceny królewskiego dramatu”), „góruje w samym sercu” → „stoi na klifie w historycznym centrum”, Trentacapilliego, „kameralne muzeum o wyraźnie tematycznym charakterze” → „niewielkie muzeum historyczne”; description przepisany (był ucięty „…”)
- **Redaktor miał rację**: „Ferdynand I Aragoński” to król Aragonii – zamek rozbudował **Ferdynand I Neapolitański (Ferrante)**, dekret z 12.11.1480 (it.wikipedia Castello di Pizzo); hełm Canovy to fragment ok. 5-metrowego posągu **Ferdynanda IV Burbona** w stroju rzymskiego wodza, stał w Pizzo do 1860, zniszczony przez garibaldczyków – nie rzeźby „przypisywanej” bez tematu; manekiny w strojach z epoki potwierdzone (progettostoriadellarte: cele w półpodziemiach, sala procesu i cela na 1. piętrze, spowiedź u kanonika Masdei)
- **Błąd redaktora**: stacja Pizzo NIE leży „u stóp klifu w Marina di Pizzo” – it.wikipedia: ok. 2 km na południe od centrum, w località Stazione; pieszo do zamku 1,6 km / 21 min (OSM routed-foot), tylko regionalne przez Tropeę; Vibo Valentia-Pizzo (IC/FR/Italo) 3,6 km / ~48 min pieszo – taksówka. Nie przyjęte też: „popiersie Murata dłuta Castexa” (niezweryfikowane), „konny” posąg (źródła opisują stojącą postać w stroju rzymskim), cytat po włosku „Salvate il viso, mirate al petto” z tłumaczeniem „serce” (niespójne) – jest wersja francuska *Épargnez le visage, visez au cœur. Feu !*
- Dodane: wyprawa z Korsyki miała lądować pod Salerno, burza zepchnęła ją do Kalabrii; grób = wspólna mogiła w podziemiach San Giorgio Martire, płyta pośrodku nawy (nie „krypty” jak u redaktora); źródła it.wikipedia Castello di Pizzo i progettostoriadellarte

## Stan 2026-09-23 (17) – fact-check redaktorski: Santa Maria dell'Isola (Tropea)
- PL+EN: banały usunięte („niekwestionowany symbol”, „wizytówka”, „najczęściej fotografowany w całych Włoszech”), szyk „ascetyczni mnisi”, „napływali licznie”, opuncje (nie „kaktusy opuncji”), „przy dobrej widoczności”, punkt widokowy zamiast „belwederu”/„łapie się kadr”, „Powrót do Tropei”; description przepisany (był ucięty „…”)
- **Redaktor miał rację**: Grotta del Palombaro to grota morska z małą plażą pod sanktuarium, dostępna głównie od wody (kajak, rower wodny, łódź) – nie przejście między plażami Rotonda i Linguata; Tropea leży na odnodze *via Tropea* (Lamezia – Rosarno). Rozkład e656: z dalekobieżnych stają tylko nocne Intercity Notte (794/795/894 Turyn, 1589 Mediolan); Frecciarossa i dzienne IC przez Vibo Valentia-Pizzo. Zdanie na Costa degli Dei („szybkie Intercity i Frecce omijają”) pozostaje poprawne
- Dodane: Roger Borsa = syn Sichelgaity (donacja potwierdzona 1090); Stromboli ok. 60 km (wyliczone z współrzędnych, ok. 61 km)
- Nie przyjęte: uogólnienie programu Ferragosto („tradycyjnie… np. orkiestry”) – zostaje konkretny program 2026 wg strony sanktuarium; wzmianka o warkoczach cebuli z sekcji uzupełnień (poza tematem strony)

## Stan 2026-09-23 (18) – fact-check redaktorski: Arena dello Stretto (Reggio)
- PL+EN (c0cd6ee): „Jego półkolista forma” (amfiteatr), „rozbłyśnie światłami”, „funkcjonowało molo”, posąg (nie „posążka”), obelisk zamiast *cippo*, linia kolejowa schowana pod ziemię zamiast *intubamento*, podwyższenie zamiast „pontonu”, Wiktor Emanuel III, Wielka Grecja, Edoarda Tresoldiego, „najpiękniejszy kilometr” jako sformułowanie przypisywane D’Annunziowi, muzeum w linkach po polsku; description przepisany (był ucięty „…”)
- **Redaktor miał rację**: Atena Promachos Bonfiglia trzyma włócznię i tarczę, w kroku z lewą nogą do przodu (viviamolacalabria, sunmoon.eu); posąg obrócił w 2001 r. burmistrz Italo Falcomatà, bo „prawdziwi wrogowie są w mieście” (it.wikipedia – podane jako przekaz, bez dopowiadania o mafii); zejście na ląd króla 31.07.1900 po zabójstwie Umberta I w Monzy (it.wikipedia); arena ok. 270 m od Piazza Italia, Piazza Indipendenza ok. 600 m dalej (przy muzeum)
- Dojście wg OSM routed-foot: Reggio Calabria Centrale 1,2 km / ok. 15 min, stacja Reggio Lido ok. 650 m / ok. 10 min, muzeum ok. 650 m w linii prostej – na stronie „10–15 min”
- Nie przyjęte: teza o znaczeniu miejsca dla propagandy faszystowskiej (niezweryfikowane); encje `&ndash;`/`&bdquo;` z pliku redaktora; włoska nazwa muzeum

## Stan 2026-09-23 (19) – fact-check redaktorski: Chianalea (Scilla)
- PL+EN: banały usunięte („miniaturowa Wenecja” we wstępie, „nie skansen”, „widok, który zostaje w pamięci”), zaułki zamiast „punktów”, makaron (maccheroni/paccheri) zamiast „pasta, maccheroni lub paccheri”, renowacje zamiast „restauracji” zamku, Fontana dei Tre Canali w nawiasie, „figuruje na liście I Borghi più Belli d'Italia” (nie „należy do stowarzyszenia” – członkami są gminy), „Powrót do Scilli”; description przepisany (był ucięty „…”)
- Dodane i potwierdzone: etymologia *Piano della Galea* / *Canalea*, też *Acquagrande* (incostaviola.it); Scaro Alaggio = pochylnia do wyciągania łodzi; cała Chianalea to ZTL tylko dla mieszkańców z przepustką, wjazd kontrolowany kamerą (comune.scilla.rc.it/it/page/ztl); stacja Scilla → Chianalea 1,1 km / ok. 15 min (OSM routed-foot, współrzędne stacji z it.wikipedia); salmoriglio „często z czosnkiem i natką”
- Pomosty restauracji na palach (*pedane sul mare*) istnieją – sezonowe, np. Il Casato, Lo Scoglio d'Ulisse – zostały z dopiskiem „latem”
- **Nie przyjęte**: Castello Ruffo codziennie 9:30–13:30/15:00–19:00, 2 €, dzieci do 10 lat i 70+ gratis – to dane ze starszych stron (FB, ilturista); zostaje komunikat gminy z 29.06.2026 jak na stronie zamku (pn. zamknięte, 3 €); *spadare* jako nazwa łodzi (spadara = łódź z sieciami dryfującymi, zakazanymi w UE – nie harpunowa); „Fontana Ruffo XVI w.” (niezweryfikowane)

## Stan 2026-09-23 (20) – fact-check redaktorski: Castello Ruffo (Scilla)
- PL+EN (bd466a9): najważniejszy zabytek (nie „obowiązkowy punkt”), sień ze sklepieniem odcinkowym (wł. *androne a volta ribassata*, nie „andron”), lenno (nie *feudo*), standardowy bilet (nie *bilet unico*), kasa biletowa, eksponaty przyrodnicze, luntre + *pesce spada*, XII księga *Odysei* (nie „Pieśń”), Dionizjusz I Starszy z Syrakuz, „Powrót do Scilli”, przejrzystość powietrza zamiast pogody; feluki (wł. *feluche*) z pomostem *passerella* (było błędne „feluca lub passarella” jako dwa typy łodzi); description przepisany (był ucięty „…”)
- **Błąd w tekście, którego redaktor nie zauważył**: De Navowie nie od 1412 – w 1469 r. Ferdynand I Neapolitański nadał zamek Gutierre De Navie (it.wikipedia, turismo.reggiocal); sprzedaż Paolowi Ruffo, hrabiemu Sinopoli, 26.12.1533 za 30 000 dukatów (strettoweb). Latarnia 1913 potwierdzona (it.wikipedia: zamknięto najwyższą część zamku)
- Redaktor miał rację: źródło Forte di Altafiumara (inna twierdza, Santa Trada) zastąpione it.wikipedia Castello Ruffo di Scilla + strettoweb
- Etna usunięta z panoramy i FAQ – zasłania ją zbocze nad Scillą (ta sama geometria co z Piazza San Rocco, sesja (1))
- **Nie przyjęte**: godziny 9:30–13:30/15:00–19:00, bilet 2 €, darmowe wejście dla dzieci do 10 lat i osób 70+, telefon 0965 704422 – dane ze starszych stron (ilturista, FB). Zostały dane z komunikatu gminy z 29.06.2026 (tak jak na stronie Chianalei); telefon 0965 616629 opisany jako „podany w komunikacie gminy”. Strona gminy nie odpowiadała (DNS EAI_AGAIN)

## Stan 2026-09-23 (21) – fact-check redaktorski: blog Pogoda w Kalabrii
- PL+EN (5d39e17): „zapada w sen” → pustoszeje, „pękają w szwach” → są zatłoczone, „zupełnie inny świat” → „klimat jest zupełnie inny”, „uderzenie frontów” → fronty nadciągające znad Morza Tyrreńskiego, W poszczególnych dniach, równina Sant'Eufemia (*Piana di Sant'Eufemia*) przy lotnisku Lamezia, Lungomare Falcomatà, Gizzeria Lido, płatne kąpieliska (*lidi*), scirocco z pyłem znad Sahary, przerwa popołudniowa w sklepach; „na płaskowyżu Sila” / „w masywie Pollino/Aspromonte” w części miejsc (odmiana „Sili” nadal poprawna)
