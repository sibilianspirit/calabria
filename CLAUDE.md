...
- W pliku PL dziedzictwa bizantyjskiego były encje  i kotwice z polskimi znakami (jedna zepsuta: ) – encje rozkodowane do znaków, id nagłówków przepisane na ASCII.  zostaje zgodnie z konwencją projektu. Warto sprawdzić pozostałe pliki pod kątem tych samych błędów
