...
- Do decyzji: „Normandzki/normandzka” (błąd: chodzi o Normanów) zostaje na stronie zamku w Gerace (tytuł, 3 nagłówki z id), na liście Kierunki (Gerace), w Catanzaro (katedra) i na Scilli (zamek Ruffo); „greko kalabryjski” w Magna Graecia (FAQ) i Dziedzictwie grekanickim
